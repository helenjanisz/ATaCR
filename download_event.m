...
startlist = 'NOISETC_SAMPLE_CI/eventtimes_CItest.txt'; % list of start times for data download, this will be the beginning of the waveform so specify appropriately, signal of interest should not be at edges of time series
...
download_stations = 'G03A'; % list of stations to download (* for all)
% Channel Names
...
datacache = 'NOISETC_SAMPLE_CI/DATA/datacache'; % output folder for data
